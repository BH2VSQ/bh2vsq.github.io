...
点击校准后，右侧日志窗口应该会弹出提示**校准开始：请转到 0°，然后发送 K0 确认**,此时将旋转器转至0°(需要在安装旋转器时，将旋转器0°置于正北方)，点击下方校准点确认中的K0按钮，此时应该提示进行到90°点的校准，依次类推，当360°点校准完成后，需要根据自己实际的旋转器的限位角度进行旋转，建议旋转角度略小于限位角度，比如说限位角度为432，则建议旋转至425左右作为记录点，然后将实际角度输入到校准点确认部分的输入框，点击K，则确定限位校准点角度以及相关电压回传记录校准点
